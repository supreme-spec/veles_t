...
export function FloatingMessengerButtons() {
      ...
      {isVisible && (
        <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2 md:hidden">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 bg-gray-400 hover:bg-gray-500 text-white rounded-full shadow-lg transition-all"
            aria-label="Закрыть"
          >
            <svg
              className="w-4 h-4"
